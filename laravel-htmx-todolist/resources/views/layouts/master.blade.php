...
<body
    ...
    <header>
        <nav style="background-image: linear-gradient( 111.4deg, rgb(173 76 132) 18.8%, rgba(4,161,255,1) 100.2% );"
            ...
            <a class="navbar-brand" href="#">Интеллектуальный поиск аудиотехники</a>
        </nav>
    </header>
                ...
                <div class="modal-body">
                    <form id="myForm" action="{{ url('/choice_page') }}" type="post">
                        <div class="form-group">
                            <select class="form-control" name="" id="h_amp_select">
                                <option target="{{ url('/') }}" value="">Поиск наушников</option>
                                <option target="{{ url('/') }}" value="">Поиск усилителей</option>
                            </select>
